...
https://metacpan.org/release/App-CISetup

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends App::CISetup
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends App::CISetup
...
The code for this distribution is [hosted at GitHub](https://github.com/maxmind/App-CISetup).
...
can submit an issue report [via the web](https://github.com/maxmind/App-CISetup/issues)
).
